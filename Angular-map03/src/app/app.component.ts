...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    this.obsGeoData = this.http.get<GeoFeatureCollection>("https://3000-e058b391-2514-404b-bdeb-6f0d4ce8d859.ws-eu01.gitpod.io/");
    this.obsGeoData.subscribe(this.prepareData);
    this.obsCiVett = this.http.get<Ci_vettore[]>("https://3000-e058b391-2514-404b-bdeb-6f0d4ce8d859.ws-eu01.gitpod.io/ci_vettore/120");
